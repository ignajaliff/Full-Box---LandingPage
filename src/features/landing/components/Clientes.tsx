      ...
      <div className="mx-auto max-w-6xl px-6 py-20">
        ...
        <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {CLIENTES_DEMO.map((cliente) => (
            <li
              key={cliente}
              className="flex h-24 items-center justify-center rounded-lg border bg-card p-4 text-center text-sm font-medium text-muted-foreground transition-all hover:text-foreground hover:shadow-sm"
            >
